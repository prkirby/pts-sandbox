/*!
 * pts.js 0.9.6 - Copyright © 2017-2021 William Ngan and contributors.
...
var CanvasForm = function (_Form_1$VisualForm) {
    ...
    _createClass(CanvasForm, [{
        ...
        value: function image(img) {
            var target = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : new Pt_1.Pt();
            var orig = arguments[2];
        ...
        value: function image(ctx, img) {
            ...
            var t = Util_1.Util.iterToArray(target);
